{
  ...
  inputs = {
    ...
    logos-liblogos = {
      url = "github:logos-fleet/logos-liblogos/419ed6ea6fd7cd324ec73e31adf60bb279fbae09";
    ...
    logos-basecamp = {
      url = "github:logos-fleet/logos-basecamp/ad670780446e23f04ab4d71eedc9bc035fe66578";
      inputs.logos-capability-module.follows = "logos-capability-module";
    ...
    logos-package-downloader = {
      url = "github:logos-fleet/logos-package-downloader/cdb185b41050c1ba218c91d1400dcbf47d5f642d";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-package.follows = "logos-package";
      inputs.nix-bundle-appimage.follows = "nix-bundle-appimage";
      inputs.nix-bundle-dir.follows = "nix-bundle-dir";
    ...
    logos-evm-keystore-module = {
      url = "github:logos-fleet/logos-evm-keystore-module/b46073dc2ae2ec0cc18d4c29232f4aa506c16b77";
      inputs.logos-module-builder.follows = "logos-module-builder";
    };
    ...
    logos-evm-wallet-ui = {
      url = "github:logos-fleet/logos-evm-wallet-ui/9f73e0f97db9caff4ad515b8dd574379055573bc";
      inputs.logos-module-builder.follows = "logos-module-builder";
